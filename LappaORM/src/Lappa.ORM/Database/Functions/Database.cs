...
namespace Lappa.ORM
{
    public partial class Database
    {
        ...
        public bool Initialize(string connString, DatabaseType type, bool useTransactions = false, bool loadConnectorFromFile = true, bool printQuery = false)
        {
            return InitializeAsync(connString, type, useTransactions, loadConnectorFromFile, printQuery).GetAwaiter().GetResult();
        }

        public async Task<bool> InitializeAsync(string connString, DatabaseType type, bool useTransactions = false, bool loadConnectorFromFile = true, bool printQuery = false)
        {
            Type = type;
